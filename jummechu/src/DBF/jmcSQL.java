...
public class jmcSQL {
    ...
    // 메뉴삽입
    public void join(lMenu2 lmenu2) {
    ...
    // 가게정보 삽입
    public void join(lStore2 lstore2) {
    ...
    // 키워드 삽입
    public void join(Review2 review2) {
    ...
    // 등록받은 식당출력
    public String pResult(String p) {
        String pfType = null;
        String pmName = null;
        String pStore = null;
        String pNum = null;
